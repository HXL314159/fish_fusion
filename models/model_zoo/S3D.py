...
class S3D(nn.Module):
    ...
    def forward(self, x):
        ...
        clipwise_output = torch.mean(y, 2)  # (2, 4)
...
def load_S3D_weight(model, file_weight='/vol/research/Fish_tracking_master/fish_fusion/pretrained_models/S3D_kinetics400.pt'):
...
if __name__ == '__main__':
    ...
    model = load_S3D_weight(model, file_weight='/vol/research/Fish_tracking_master/FishMM/pretrained_models/S3D_kinetics400.pt')
    input = torch.randn(1, 20, 3, 224, 224).cuda()
    output = model(input)
